  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route exact path="/product-type/mobiles" element={<Allproductpage type={'Mobiles'} />} />
        <Route exact path="/product-type/laptops" element={<Allproductpage type={'Laptops'} />} />
        <Route exact path="/product-type/cameras" element={<Allproductpage type={'Cameras'} />} />
